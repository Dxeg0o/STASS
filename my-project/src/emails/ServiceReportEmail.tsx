          ...
          <Section style={{ padding: "32px 34px 34px" }}>
            ...
            <Text style={{ color: "#475569", fontSize: 13, lineHeight: "20px" }}>
              {daily.calibreSource === "declarado"
                ? "Los PDFs incluyen calibre declarado por salida, porcentaje y bins / PDFs include size declared by output, percentage and bins."
                : "Los PDFs incluyen detalle por lote, calibre, porcentaje y bins / The PDFs include lot, size, percentage and bins."}
            </Text>
